...
include::{snippets}/list-people-xml/response-fields.adoc[]

==== Example request

include::{snippets}/list-people/curl-request.adoc[]
include::{snippets}/list-people-xml/curl-request.adoc[]

==== Example response

include::{snippets}/list-people/http-response.adoc[]
include::{snippets}/list-people-xml/http-response.adoc[]
